...
import { getProveedores, getProveedor, createProveedor, updateProveedor, deleteProveedor } from "../controlers/Provedor";
 ...
 *         description: Error del servidor
 */
router.post("/provedor/create", createProveedor);
 ...
 *         description: Error del servidor
 */
router.put("/provedor/update/:id", updateProveedor);
 ...
 *         description: Error del servidor
 */
router.delete("/provedor/delete/:id", deleteProveedor);

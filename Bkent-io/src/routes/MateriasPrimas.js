...
import { getMateriasPrimas, getMateriaPrima, createMateriaPrima, updateMateriaPrima, deleteMateriaPrima } from "../controlers/MateriasPrimas";
 ...
 */
router.get("/Materias/Primas", getMateriasPrimas);
 ...
 *         description: Error del servidor
 */
router.get("/Materia/Prima/:id", getMateriaPrima);
 ...
 *         description: Error del servidor
 */
router.post("/Materia/Prima/Create", createMateriaPrima);
 ...
 *         description: Error del servidor
 */
router.put("/Materia/Prima/Update/:id", updateMateriaPrima);
 ...
 *         description: Error del servidor
 */
router.delete("/Materia/Prima/Delete/:id", deleteMateriaPrima);

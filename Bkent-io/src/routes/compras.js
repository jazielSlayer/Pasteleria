...
import { getCompras, getCompra, createCompra, recibirCompra, cancelarCompra } from "../controlers/Compras";
 ...
 *         description: Error del servidor
 */
router.post("/cerate/compra", createCompra);
 ...
 *         description: Error del servidor
 */
router.put("/recibir/compra/:id", recibirCompra);
 ...
 *         description: Error del servidor
 */
router.delete("/cancelar/compra/:id", cancelarCompra);

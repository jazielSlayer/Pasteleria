...
import { createMovimiento, createMovimientoManual, deleteMovimiento, getMovimiento, getMovimientos } from "../controlers/MovimientoInvetario";
 ...
 *         description: Error del servidor
 */
router.post("/movimiento/manual/create", createMovimientoManual);
 ...
 *         description: Error del servidor
 */
router.delete("/movimiento/delete/:id", deleteMovimiento);

...
var _MateriasPrimas = require("../controlers/MateriasPrimas");
 ...
 */
router.get("/Materias/Primas", _MateriasPrimas.getMateriasPrimas);
 ...
 *         description: Error del servidor
 */
router.get("/Materia/Prima/:id", _MateriasPrimas.getMateriaPrima);
 ...
 *         description: Error del servidor
 */
router.post("/Materia/Prima/Create", _MateriasPrimas.createMateriaPrima);
 ...
 *         description: Error del servidor
 */
router.put("/Materia/Prima/Update/:id", _MateriasPrimas.updateMateriaPrima);
 ...
 *         description: Error del servidor
 */
router["delete"]("/Materia/Prima/Delete/:id", _MateriasPrimas.deleteMateriaPrima);

 ...
 *         description: Error del servidor
 */
router.post("/promocion/crear", _Promociones.createPromocion);
 ...
 *         description: Error del servidor
 */
router.put("/promoacion/update/:id", _Promociones.updatePromocion);
 ...
 *         description: Error del servidor
 */
router["delete"]("/promoacion/delete/:id", _Promociones.deletePromocion);

...
var _Compras = require("../controlers/Compras");
 ...
 */
router.get("/compras", _Compras.getCompras);
 ...
 *         description: Error del servidor
 */
router.get("/compra/:id", _Compras.getCompra);
 ...
 *         description: Error del servidor
 */
router.post("/cerate/compra", _Compras.createCompra);
 ...
 *         description: Error del servidor
 */
router.put("/recibir/compra/:id", _Compras.recibirCompra);
 ...
 *         description: Error del servidor
 */
router["delete"]("/cancelar/compra/:id", _Compras.cancelarCompra);

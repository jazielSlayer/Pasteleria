 ...
 *         description: Error del servidor
 */
router.post("/cliente/buscar", _Clientes.buscarCliente);
 ...
 *         description: Error del servidor
 */
router.put("/cliente/create", _Clientes.createCliente);
 ...
 *         description: Error del servidor
 */
router["delete"]("/cliente/update/:id", _Clientes.updateCliente);
 ...
 *         description: Error del servidor
 */
router.get("/cliente/delete/:id", _Clientes.deleteCliente);
